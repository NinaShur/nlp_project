...
page = st.sidebar.radio(
    ...
    [
        ...
        "Страница 2 • Классификация новостей из Telegram", 
        "Страница 3 • Генерация текста в стиле Форреста Гампа"
    ]
)
...
if page.startswith("Страница 1"):
    st.title("Страница 1 — Классификация отзывов на рестораны")
...
# =========================
    ...
    if st.button("Классифицировать"):
        ...
        state_dict = torch.load("lstm_weights.pt", map_location="cpu")
        ...
        # Матрицы ошибок
        # -------------------------
        st.subheader("Матрицы ошибок и метрики по моделям")

        st.write("Матрица ошибок TF-IDF:")
        st.image("confmat_tfidf.png")

        st.write("Матрица ошибок LSTM:")
        st.image("confmat_lstm.png")

        st.write("Матрица ошибок RuBERT:")
        st.image("confmat_rubert.png")
...
# =========================
    ...
    def load_gpt_model():
        try:
            ...
            model_path = 'model_gump'  # Просто имя папки, без точек и слешей
    ...
    prompt = st.text_area(
        ...
        # placeholder="Мама всегда говорила...",
        height=100
    )
